...
def generate_grid(grid_width, grid_height, square_size):
    ...
    skyGrid = [[{"color": 1, "cell": None, "eter": -1, "height": grid_height - dirtHeight - sunHeight - y, "sun": 3, "minerals": -1} for _ in range(grid_width)] for y in range(grid_height - sunHeight - dirtHeight)]
