...
def generate_grid(grid_width, grid_height, square_size):
    ...
    sunGrid = [[{"color": 2, "cell": None, "eter": -1, "height": grid_height - dirtHeight - y, "sun": 1, "minerals": -1} for _ in range(grid_width)] for y in range(sunHeight)]
    skyGrid = [[{"color": 1, "cell": None, "eter": -1, "height": grid_height - dirtHeight - sunHeight - y, "sun": 1, "minerals": -1} for _ in range(grid_width)] for y in range(grid_height - sunHeight - dirtHeight)]
